...
class RecentPathsHandler    {
    public:
        ...
        */
        std::string get_recent_file_path(AstroPhotoStacker::FrameType frame_type, const std::string &default_value = "")  const;
        ...
        */
        void set_recent_file_path_from_file(AstroPhotoStacker::FrameType frame_type, const std::string &recent_file_path) const;
         ...
         * @return std::string path to the most recently used folder
        */
        std::string get_recent_file_path(RecentPathSettings recent_path_setting, const std::string &default_value = "")  const;
    ...
    private:
        ...
        std::map<AstroPhotoStacker::FrameType, std::string> m_frame_type_to_txt_file = std::map<AstroPhotoStacker::FrameType, std::string>({
            {AstroPhotoStacker::FrameType::FLAT ,       "recent_flat_paths.txt"},
            {AstroPhotoStacker::FrameType::LIGHT ,      "recent_lights_paths.txt"},
            {AstroPhotoStacker::FrameType::DARK ,       "recent_dark_paths.txt"},
            {AstroPhotoStacker::FrameType::BIAS ,       "recent_bias_paths.txt"},
            {AstroPhotoStacker::FrameType::UNKNOWN ,    "recent_unknown_paths.txt"},
        });
