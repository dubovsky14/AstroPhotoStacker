...
float AstroPhotoStacker::RandomUniform()  {
...
bool AstroPhotoStacker::StartsWith(const string &main_string, const string &prefix)    {
...
bool AstroPhotoStacker::EndsWith(const string &main_string, const string &suffix)    {
...
bool AstroPhotoStacker::StringIsInt(const string &x)    {
    try {
        std::stoi(x);
    }
    catch (...) {
...
bool AstroPhotoStacker::StringIsFloat(const string &x)   {
    try {
        std::stod(x);
    }
    catch (...) {
...
vector<string> AstroPhotoStacker::SplitAndStripString(string input_string, const string &separator) {
...
vector<string> AstroPhotoStacker::SplitString(string input_string, const string &separator)    {
...
std::vector<std::string> AstroPhotoStacker::SplitByWhitespaces(std::string line)   {
...
void AstroPhotoStacker::StripString(string *input_string, const string &chars_to_remove)    {
