...
/**
 * @brief Class for stacking photos using minimal value. This can be useful to get flat frames.
 *
 */

namespace AstroPhotoStacker {
    class StackerMinimum : public StackerSimpleBase {
        public:
            /**
            ...
            */
            StackerMinimum(int number_of_colors, int width, int height, bool interpolate_colors);
